...
const PricingCard1 = () => {
    return (
        <div className="flex flex-col md:h-full p-4 mx-auto font-radio w-full md:w-5/12 text-center text-white rounded-lg border border-turqoise">
              <h3 className="mb-0 md:mb-2 text-2xl font-semibold">Professional</h3>
...
const PricingCard2 = () => {
    return (
        <div className="flex flex-col p-4 mx-auto font-radio w-full md:w-5/12 text-center text-white rounded-lg border border-turqoise">
              <h3 className="mb-0 md:mb-2 text-2xl font-semibold">Business</h3>
...
const PricingCard3 = () => {
    return (
        <div className="flex flex-col p-4 mx-auto font-radio w-full md:w-5/12 text-center text-white rounded-lg border border-turqoise">
              <h3 className="mb-0 md:mb-2 text-2xl font-semibold">Custom</h3>
              <p className="font-light text-gray-400 sm:text-base">Need more than Professional?</p>
              <div className="flex justify-center items-baseline my-2 md:my-8">
                  <span className="mr-2 text-2xl md:text-4xl font-extrabold">Contact Me</span>
